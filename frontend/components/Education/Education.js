            ...
            <div className={classes.about}>
              <div className={classes.reward}>
                <div className={classes.item}>
                  <Typography variant="h5" className={clsx(classes.title, text.subtitle)}>{data['heading']}</Typography>
                  <figure>
                    <img src={data['img']} alt="badge" />
                  </figure>
                  <Typography variant="p" className={text.subtitle}>{data['degree']}</Typography>
                  <br />
                  <Typography variant="p" className={text.subtitle}>{data['tenure']}</Typography>
                </div>
              </div>
              <Hidden mdUp>
